...
public class Kicker extends SubsystemBase{
    ...
    private SparkClosedLoopController m_KickerPID;
    private RelativeEncoder m_KickerEncoder;
    ...
    public Kicker(){
        ...
        m_Kicker.configure(SpindexerMotorConfig, ResetMode.kResetSafeParameters, PersistMode.kNoPersistParameters);
    }
